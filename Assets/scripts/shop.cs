...
public class shop : MonoBehaviour
{
    ...
    public GameObject fish26;public GameObject fish27;public GameObject fish28;
    ...
    public void Fish27buy()
    {
        float randomX = Random.Range(spawnRangeX.x, spawnRangeX.y);
        Vector2 spawnPosition = new Vector2(randomX, spawnY);
        
        Instantiate(fish27, spawnPosition , fish27.transform.rotation);
    }
     public void Fish28buy()
    {
        float randomX = Random.Range(spawnRangeX.x, spawnRangeX.y);
        Vector2 spawnPosition = new Vector2(randomX, spawnY);
        
        Instantiate(fish28, spawnPosition , fish28.transform.rotation);
    }
